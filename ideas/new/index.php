  ...
  <div class="width">
    <div id="nav">
      ...
      <div class="outside" class="width">
		...
		<!-- Login Required -->
			<div class="pane-content">
				<div class="pane-content-intro error">You must be logged in to receive credit for this idea!</div>
		...
		<!-- Successful Submission -->
			<div class="pane-content">
				<div class="panel">
					<div class="pane-content-intro">Your idea was submitted successfully! Great! </div>
