        ...
        <div id="wrapper">
				...
				<div class="pane-content">
					...
					<div>
						<datalist id = "idea">
							...
							<option value="<?php echo $ideas["id"] ?>"></option>
							<?php }} ?>
						</datalist>
						<input type="text" list="idea">
					...
					<button class="accordion active">Date of Completion [OPTIONAL]</button>
            ...
            <div class="pane" data-index="3">
                <div class="pane-content">
					...
					<div class="login-warning active">To publish you must have an account!</div>
				</div>
